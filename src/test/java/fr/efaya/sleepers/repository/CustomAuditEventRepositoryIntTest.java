...
import fr.efaya.sleepers.config.audit.AuditEventConverter;
import fr.efaya.sleepers.domain.PersistentAuditEvent;
...
import static fr.efaya.sleepers.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
